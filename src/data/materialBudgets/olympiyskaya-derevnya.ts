...
/**
 * Смета расхода материалов — Олимпийская деревня.
 *
 * Составлена по образцу наполненности Брусилова (тот же набор статей),
 * пока не придёт отдельная ведомость по объекту.
 *
 ...
 * правим цифры здесь.
 */
export const OLYMPIYSKAYA_DEREVNYA_MATERIAL_BUDGET: MaterialBudget = {
