        ...
        <>
          ...
          >
            <HubCard
              ...
              lead={
                unseen > 0
                  ? `${unseen} новых — назначить и контролировать исполнение.`
                  : 'Назначить сотруднику, контролировать сроки и переписку.'
              }
              tone="tasks"
              icon={TASKS_ICON}
            ...
            {showHubs ? (
              <>
                <HubCard
                  ...
                  title="Спецтехника"
                  lead="Карточки техники, сроки документов и ремонты по парку."
                  tone="fleet"
                  icon={FLEET_ICON}
                  tags={['ТО', 'Страховки', 'Ремонты']}
                  cta="Открыть"
                />
                ...
                <HubCard
                  ...
                  lead="Приёмка на площадке: фиксация, фото и решения."
                  tone="inspect"
                  icon={INSPECTION_ICON}
                  tags={['Чек-листы', 'Фото', 'Отчёты']}
                  cta="Открыть"
